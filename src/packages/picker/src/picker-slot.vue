...
<script type="text/babel">
	let font_size = document.documentElement.clientWidth / 7.5;
  import draggable from '../src/draggable';
  import translateUtil from '../src/translate';
  import { once, addClass, removeClass } from '../../../packagesTool/utils/dom';
  import emitter from '../../../packagesTool/mixins/emitter';
  import Vue from 'vue';
  ...
  export default {
    ...
    computed: {
    	rem2px() {
    		return font_size * this.itemHeight
    	},
      flexStyle() {
        return {
          'flex': this.flex,
