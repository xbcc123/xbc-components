...
@import "../../../packagesTool/style/var.scss";
	...
	.mint-swipe-indicator{
		@include tapSize($indicatorSize, $indicatorSize);
...
<template>
	<div class="mint-swipe-content" :class="[sizeType]">
...
<script>
  import { once } from '../../../packagesTool/utils/dom';
  import { addClass, removeClass } from '../../../packagesTool/utils/dom';
